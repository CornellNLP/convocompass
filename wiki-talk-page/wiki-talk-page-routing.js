//<nowiki>
/**
 * Filename: wiki-talk-page-routing.js
 * ConvoCompass LLM – Newcomer-oriented talk-page assistance (Wikipedia userscript)
 *
 * Fork of the live User:Chaotic_Enby/ConvoWizardRouting.js
 * Expects a YAML generating a list of policy pages and fetches human-written nutshells for these, which are displayed
 * LLM logic only involved in the backend detection
 */
(async function () {
    'use strict';
